...
public class MovieDetails extends AppCompatActivity implements ReviewAdapter.ReviewAdapterOnClickHandler{
  ...
  private   boolean infav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = intent.getParcelableExtra("position");
        Log.d("MovieDetails","id"+data.getID());
        Log.d("MovieDetails","id"+data.getOriginalTitle());
     updateUi();
      ...
      Log.d("MovieDetails","hello"+data.getID());
